...
<img src='__PUBLIC__/up/Product_image/<?php echo ($list[0]["image_name"]); ?>'/>
<p>【药品名称】<?php echo ($list[0]["name"]); ?></p>
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><p>【<?php echo ($vo["attribute"]); ?>】<?php echo ($vo["value"]); ?></p><?php endforeach; endif; else: echo "" ;endif; ?>
