...
<div id="here_area" class="fl">当前位置&nbsp;&gt;&gt;产品列表&nbsp;</div>
      </div>
    </div>
 <div class="main">
...
<a href="__URL__/preview/name/<?php echo ($vo["name"]); ?>">
<img alt="<?php echo ($vo["name"]); ?>" title="<?php echo ($vo["name"]); ?>" src="__PUBLIC__/up/Product_image/<?php echo ($vo["image_name"]); ?>"/></a>
<a href="__URL__/preview/name/<?php echo ($vo["name"]); ?>"><?php echo ($vo["name"]); ?></a> 
<a class="b1"  href="__URL__/delete_product/name/<?php echo ($vo["name"]); ?>">删除</a>
