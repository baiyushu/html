...
<div id="here_area" class="fl">当前位置&nbsp;&gt;&gt;资料管理&nbsp;</div>
      </div>
    </div>
 <div class="main">
...
<div class="wrap">
<table>
<tr><th width="400px"></th><th width="200px"></th><th width="50px"></th></tr>
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
<td><a href="__APP__/Filedownload/index/Id/<?php echo ($vo["Id"]); ?>"><?php echo ($vo["describle"]); ?></td><td><?php echo ($vo["DateTime"]); ?>
</td><td width="50px"><a class="b1"  href="__URL__/delete_file/Id/<?php echo ($vo["Id"]); ?>">删除</a></td>
